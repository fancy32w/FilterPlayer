...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public native void  _smiShowLog();
    public native void  SmiSyncReleaseOutEnable();
    public native void  SmiSyncReleaseOutDisable();
    public native void  SmiSyncReleaseOut();
    public native long  SmiGetCurrentPosition();
