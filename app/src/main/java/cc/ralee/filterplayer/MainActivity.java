...
public class MainActivity extends BaseActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener, View.OnTouchListener {
...
//                videoRenderer.changeVideoPathAndPlay("rtp://0.0.0.0:50000");
            ...
            case R.id.pause:
                Log.d(TAG, "onClick:  pause clicked");
